...
public class CommonServiceImpl implements CommonService {
    ...
    @Override
    public AppResponceDTO processCreate(@RequestBody ChannelDTO channelDTO)
    {
        ...
        try 
        {
            ...
            LOGGER.info("request Sent successfully  created channel: {}", channelDTO);
            return response.getBody();
            
        }
        catch (Exception e) 
        {
            LOGGER.error("Exception while processing create channel"+"url:{},exception:{}","http://localhost:8080/workqueue/", e);
